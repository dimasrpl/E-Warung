...
<body>
	...
	<div class="animsition">
		<div class="appHeader">
	     	<p id="headerText">Item telah ditambahkan!</p>
	     </div>
		...
		<div class="signup-handler-area">
	     	...
	     	<a href="confirm-order.php" class="btn btn-lg btn-default animsition-link button homeButtons" role="button">Pergi ke keranjang</a>
	     	<a href="menu-item-removed.php" class="btn btn-lg btn-default animsition-link button homeButtons" role="button">Hapus item</a>
	 	</div>    
	</div>
