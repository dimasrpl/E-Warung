...
<html>
	...
	<body>
			...
			<?php
			  ...
			  if (mysqli_num_rows($result) > 0) {
				  ...
				  while($row = $result->fetch_assoc()) {
					  echo "<p id=\"headerText\">"."Selamat Datang"." ".$row["firstName"]. "!";
				  } 
			  }
		...
		<div class="welcome-area">
			<a href="#" class="btn btn-lg btn-info button welcomeButtons">
				<span class="glyphicon glyphicon-map-marker"> </span> Cari Warung Terdekat
			</a> 
			<br>
			<a href="menu.html" class="btn btn-lg btn-info button welcomeButtons">
				<span class="glyphicon glyphicon-shopping-cart"> </span> Pesan Sekarang
			</a> 
            <a href="live-track.php" class="btn btn-lg btn-info button welcomeButtons">
	<span class="glyphicon glyphicon-road"> </span> Melacak Pesanan</a> 
            <a href="write-review.php" id="reviewOrder" class="btn btn-lg btn-info button welcomeButtons"><span class="glyphicon glyphicon-pencil"> </span> Tulis Ulasan</a> 
            <a href="review-history-responses.php" id="responses" class="btn btn-lg btn-info button welcomeButtons"><span class="glyphicon glyphicon-list-alt"> </span>
Tinjau riwayat dan respons</a> 
            <a href="my-account.html" class="btn btn-lg btn-info button welcomeButtons"><span class="glyphicon glyphicon-user"> </span> Akun</a> 
            <a href="sign-out.php" class="btn btn-lg btn-info button welcomeButtons">Keluar</a> 
        </div> 
