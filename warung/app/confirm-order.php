...
<html lang="en">
  ...
  <body id="sign-up-page">
	...
	<div class="animsition">
		...
		<div class="appHeader">
			<p id="headerText">Order Konfirmasi</p>
		</div>
		...
		<div class="confirm-area">
    		...
    		<?php
				...
				foreach ($addedItems as $value)
				{
					...
					echo "</td>";
					echo "<td>";
					echo "<button type=\"button\" class=\"btn btn-danger\" onclick=\"removeItem(this)\">Hapus</button>";
					echo "</td>";
					echo "</tr>";
				}
			 ?>
			...
			<form id="additional-area" action="order-confirmed.php" method="post">
				...
				<div class="form-group">
 			  	...
 			  	<div class="form-group">
  			  		<label for="currentPoints">Points yang didapat</label>
				    ...
				    ?>
   			  	...
   			  	<div class="form-group">
   			  		...
   			  		<select id="orderType" class="form-control" name="orderType">
   			  			<option>Antar Online</option>
   			  			<option>Ambil sendiri</option>
   			  		</select>
   			  	</div>
		  		
				<div class="form-group">
 					<button type="submit" class="btn btn-lg btn-default button" id="signup-button">Konfirmasi Order</button>
				</div>
 			</form>
		</div>
	</div>
