...
<html lang="en">
  ...
  <body onload = "getOrders()">
	...
	<div class="header">
		<p id="welcomeText">Kelola Order User</p>
	</div>
	...
	<h3 id="orderDetails">Detail Order</h3>
		  ...
		  xmlHTTPRequest.onreadystatechange = function()
		  {
			  if (xmlHTTPRequest.readyState == 4 && xmlHTTPRequest.status == 200)
			  {
				  ...
				  for (var i = 0; i < theData.length-1; i++)
				  {
					  ...
					  row.insertCell(8).innerHTML = "<button type=\"button\" id=\"a\" onclick=\"getOrderDetails(this)\" class=\"btn btn-lg btn-default interfaceButton\">Lihat Detail Order</button>";
