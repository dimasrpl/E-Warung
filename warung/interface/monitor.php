...
<html lang="en">
  ...
  <body onload="getReviews()">
	...
	<div class="response-area">
		<h2 id="responseNumber">Tak da respon</h2>
		<textarea style="visibility:hidden;" class="form-control" id="response"></textarea>
		<button style="visibility:hidden;" type="submit" class="btn btn-lg btn-default button" id="saveResponse" onclick="submitResponse()">Simpan Ulasan</button>	
	</div>
